...
search.addEventListener("click", () => {
  ...
  document
    ...
    .insertAdjacentHTML(
      "beforebegin",
      '<li id="cont-search" class="container-icon-search"><img class="icon-header search-temp" id="search-temp" src="./img/search-white.svg" alt="search"><input class="searcharea" type="text"></li>'
    );
