ymaps.ready(function () {
  ...
  // ---------------------------------------К леднику Безенги (Кавказская экотропа)+------------------------
  var myPolyline = new ymaps.Polyline(
    [
      // Указываем координаты вершин.
  ...
  var startPoint = new ymaps.Placemark(
    ...
    {
      hintContent: "К леднику Безенги",
      balloonContent: `<figure class="popular-item swiper-slide">
      <img src="BALLON CONTENT/К леднику безенги.jpg" alt="Экотропа" class="trail-img">
      <figcaption class="trail-info">
          <a href="#" class="trail-title-link">
              <h2 title="К леднику Безенги (Кавказская экотропа)" id="color-letters" class="bold-paragraph size-card-elem-h2">К леднику Безенги</h2>
          </a>
          <a href="#" id="trail-location" class="trail-location-black " title="Кабардино-Балкария, ущелье Безенги">
              <p class="size-card-elem-p" id="color-letters">Кабардино-Балкария, ущелье Безенги</p>
          </a>
          <div class="trail-spec">
              <a href="#" class="trail-distance">
                  <div class="img-card-color">
                  ...
                  <p id="color-letters" class="bold-paragraph">4,5 км</p>
              </a>
              <a href="#" class="trail-difficulty">
                  <div class="img-card-color">
                      <img src="BALLON CONTENT/difficulty-black.svg" alt="Сложность тропы">
                  </div>
                  <p id="color-letters" class="bold-paragraph">Сложная</p>
              </a>
              <a href="#" class="trail-duration">
                  <div class="img-card-color">
                      <img src="BALLON CONTENT/duration-black.svg" alt="Длительность тропы">
                  </div>
                  <p id="color-letters" class="bold-paragraph">~3 ч</p>
              </a>
          </div>
      </figcaption>
  </figure>
  ...
  var startPoint = new ymaps.Placemark(
    [60.1796486525997, 29.800175362963255],
    {
      hintContent: "Комаровский берег",
      balloonContent: `<figure class="popular-item swiper-slide">
      <img src="BALLON CONTENT/Комаровский берег.jpg" alt="Экотропа" class="trail-img">
      <figcaption class="trail-info">
          <a href="#" class="trail-title-link">
              <h2 title="Комаровский берег" id="color-letters" class="bold-paragraph size-card-elem-h2">Комаровский берег</h2>
          </a>
          <a href="#" id="trail-location" class="trail-location-black " title="Ленобласть, пос. Комарово">
              <p class="size-card-elem-p" id="color-letters">Ленобласть, пос. Комарово</p>
          </a>
          <div class="trail-spec">
              <a href="#" class="trail-distance">
                  <div class="img-card-color">
                  ...
                  <p id="color-letters" class="bold-paragraph">3 км</p>
              </a>
              <a href="#" class="trail-difficulty">
                  <div class="img-card-color">
                      <img src="BALLON CONTENT/difficulty-black.svg" alt="Сложность тропы">
  ...
  var myPolyline = new ymaps.Polyline(
    [
      ...
      [43.83963264274915, 39.558707479820725],
      [43.83995879879184, 39.5587718528371],
      [43.84029271859456, 39.55848217426347],
      [43.84084407042887, 39.55810130058336],
      [43.84140506972348, 39.55829086855416],
      [43.84177004282857, 39.55833914831642],
      [43.84198358987934, 39.5582801397181],
      [43.84205347783788, 39.55837669924263],
      [43.84237962055435, 39.558408885750815],
      [43.84256986964314, 39.55847325876718],
      [43.84275235288898, 39.558494716439284],
      [43.843664760686984, 39.558838039193205],
      [43.845153711577815, 39.56126361040904],
      [43.846494025432335, 39.56237746321063],
      [43.8469560257858, 39.56246865831713],
      [43.847348140905915, 39.5639224156032],
      [43.84867938998875, 39.56681044562018],
    ],
    [],
  ...
  var startPoint = new ymaps.Placemark(
    [43.83962503817255, 39.55871867024417],
    {
      hintContent: "33 водопада",
      balloonContent: `<figure class="popular-item swiper-slide">
      <img src="BALLON CONTENT/for-slider-14-Краснодар-33-водопада.jpg" alt="Экотропа" class="trail-img">
      <figcaption class="trail-info">
          <a href="#" class="trail-title-link">
              <h2 title="33 водопада" id="color-letters" class="bold-paragraph size-card-elem-h2">33 водопада</h2>
          </a>
          <a href="#" id="trail-location" class="trail-location-black " title="Краснодарский край, Сочи, Лазаревский р-н">
              <p class="size-card-elem-p" id="color-letters">Краснодарский край, Сочи, Лазаревский р-н</p>
          </a>
          <div class="trail-spec">
              <a href="#" class="trail-distance">
                  <div class="img-card-color">
                  ...
                  <p id="color-letters" class="bold-paragraph">0,6 км</p>
              </a>
              <a href="#" class="trail-difficulty">
                  <div class="img-card-color">
                      <img src="BALLON CONTENT/difficulty-black.svg" alt="Сложность тропы">
  ...
  var endPoint = new ymaps.Placemark(
    [43.848676651746736, 39.566805240071595],
    {
      hintContent: "Конец маршрута",
      balloonContent: "Это конец маршрута",
    },
  ...
  var startPoint = new ymaps.Placemark(
    [44.82502337206724, 34.91605322511201],
    {
      ...
      balloonContent: `<figure class="popular-item swiper-slide">
      <img src="BALLON CONTENT/for-slider-22-Крым-Тропа-Голицына.jpg" alt="Экотропа" class="trail-img">
      <figcaption class="trail-info">
          <a href="#" class="trail-title-link">
              <h2 title="Тропа Голицына" id="color-letters" class="bold-paragraph size-card-elem-h2">Тропа Голицына</h2>
          </a>
          <a href="#" id="trail-location" class="trail-location-black " title="Крым, Судак, пгт. Новый Свет">
              <p class="size-card-elem-p" id="color-letters">Крым, Судак, пгт. Новый Свет</p>
          </a>
          <div class="trail-spec">
              <a href="#" class="trail-distance">
                  <div class="img-card-color">
                  ...
                  <p id="color-letters" class="bold-paragraph">8 км</p>
              </a>
              <a href="#" class="trail-difficulty">
                  <div class="img-card-color">
                      <img src="BALLON CONTENT/difficulty-black.svg" alt="Сложность тропы">
              ...
              <a href="#" class="trail-duration">
                  ...
                  <p id="color-letters" class="bold-paragraph">~4 ч</p>
              </a>
          </div>
      </figcaption>
  </figure>
  ...
  var myPolyline = new ymaps.Polyline(
    [
      ...
      [44.45281280341544, 34.12840237274328],
      [44.45263379759744, 34.12838524676592],
      [44.45249931236148, 34.128288687241394],
      [44.45230334760232, 34.128095568192315],
      [44.45206127257398, 34.12809020377429],
      [44.45194599839589, 34.128058017266106],
      [44.45183456647263, 34.12796682215961],
      [44.45177692918697, 34.12788635588916],
      [44.451592489487936, 34.12737673617632],
      [44.45154253696854, 34.127237261307556],
      [44.45137346658364, 34.12700659133227],
      [44.45119474759396, 34.12684602733441],
      [44.45108715676096, 34.12680311199017],
      [44.450952667939106, 34.12680311199017],
      [44.45079896604658, 34.12684602733441],
      [44.45061068067323, 34.12703378196546],
      [44.450445450148244, 34.12728590961286],
      [44.45033017275906, 34.12744147773572],
      [44.45021105254956, 34.12746829982588],
      [44.4500727190961, 34.12743611331769],
      [44.4497051060188, 34.127386347126055],
      [44.449470705428624, 34.127370253871945],
      [44.44907491211833, 34.127477542232555],
      [44.448817452884356, 34.12757410175708],
      [44.448486981148235, 34.12777258522418],
      [44.44836444713656, 34.12776976285222],
      [44.448206895662246, 34.12770002541782],
      [44.44810314201866, 34.1276785677457],
      [44.447922533381636, 34.12783950028659],
      [44.44783030747777, 34.127855593540694],
      [44.44776882346043, 34.12780194936038],
      [44.44772655316069, 34.127662474491615],
      [44.44757284272021, 34.12712603268864],
      [44.44733459073264, 34.126750523426544],
      [44.44720009321079, 34.126611048557784],
      [44.44698105372209, 34.12655203995944],
      [44.44680256569916, 34.12653565137256],
      [44.44654125354622, 34.12657052008976],
  ...
  var startPoint = new ymaps.Placemark(
    [44.45837696275593, 34.136785709947716],
    {
      ...
      balloonContent: `<figure class="popular-item swiper-slide">
      <img src="BALLON CONTENT/for-slider-24-Крым-Солнечная-тропа.jpg" alt="Экотропа" class="trail-img">
      <figcaption class="trail-info">
          <a href="#" class="trail-title-link">
              <h2 title="Солнечная тропа" id="color-letters" class="bold-paragraph size-card-elem-h2">Солнечная тропа</h2>
          </a>
          <a href="#" id="trail-location" class="trail-location-black " title="Крым, Ялта">
              <p class="size-card-elem-p" id="color-letters">Крым, Ялта</p>
          </a>
          <div class="trail-spec">
              <a href="#" class="trail-distance">
                  <div class="img-card-color">
                  ...
                  <p id="color-letters" class="bold-paragraph">6 км</p>
              </a>
              <a href="#" class="trail-difficulty">
                  <div class="img-card-color">
                      <img src="BALLON CONTENT/difficulty-black.svg" alt="Сложность тропы">
              ...
              <a href="#" class="trail-duration">
                  ...
                  <p id="color-letters" class="bold-paragraph">~2 ч</p>
              </a>
          </div>
      </figcaption>
  </figure>
  ...
  var startPoint = new ymaps.Placemark(
    [55.83383980174827, 37.613395747467365],
    {
      ...
      balloonContent: `<figure class="popular-item swiper-slide">
      <img src="BALLON CONTENT/for-slider-13-МСК-ВДНХ.jpg" alt="Экотропа" class="trail-img">
      <figcaption class="trail-info">
          <a href="#" class="trail-title-link">
              <h2 title="Воздушная экотропа" id="color-letters" class="bold-paragraph size-card-elem-h2">Воздушная экотропа</h2>
          </a>
          <a href="#" id="trail-location" class="trail-location-black " title="Москва, Останкинский р-н">
              <p class="size-card-elem-p" id="color-letters">Москва, Останкинский р-н</p>
          </a>
          <div class="trail-spec">
              <a href="#" class="trail-distance">
                  <div class="img-card-color">
                  ...
                  <p id="color-letters" class="bold-paragraph">0,5 км</p>
              </a>
              <a href="#" class="trail-difficulty">
                  <div class="img-card-color">
                      <img src="BALLON CONTENT/difficulty-black.svg" alt="Сложность тропы">
              ...
              <a href="#" class="trail-duration">
                  ...
                  <p id="color-letters" class="bold-paragraph">~0,5 ч</p>
              </a>
          </div>
      </figcaption>
  </figure>
  ...
  var myPolyline = new ymaps.Polyline(
    [
      ...
      [60.16792512310169, 30.533956837345933],
      [60.16752951193625, 30.532111477543705],
      [60.16670085143797, 30.528345656086785],
      [60.16679708405583, 30.527079653431766],
      [60.16619829872813, 30.525191378285278],
      [60.166118103433256, 30.52494461505591],
      [60.16592028753297, 30.524579834629886],
      [60.16579197387768, 30.52452619044957],
      [60.16562088822194, 30.52471930949865],
      [60.16544445520335, 30.524805140187123],
      [60.16528406072529, 30.52460129230199],
      [60.16525732823594, 30.523957562138417],
      [60.16545514814064, 30.52315289943395],
      [60.165572770220216, 30.52276666133582],
      [60.165460494607956, 30.522101473500115],
      [60.16534287212513, 30.521876167942878],
      [60.165134358503735, 30.52185471027075],
      [60.164840298576316, 30.521876167942878],
      [60.16470128750978, 30.521919083287113],
      [60.164476729925035, 30.522326779057376],
      [60.1643751438452, 30.522680830647346],
      [60.164038303536536, 30.52304561107337],
      [60.16389928906593, 30.523388933827263],
      [60.16369076625374, 30.523742985417233],
      [60.163402040168194, 30.523979019810547],

      [60.1667107504262, 30.524711933423855],
      [60.16705391187088, 30.523913976241932],
      [60.167219643861245, 30.52345263629136],
      [60.1674388364958, 30.52326488166033],
      [60.167658027663194, 30.52297520308673],
      [60.16782108355558, 30.52265870242297],
      [60.16796810046749, 30.522562142898416],
      [60.16821936420706, 30.5225943294066],
      [60.16858556428993, 30.522739168693416],
      [60.16915223079911, 30.523103949119438],
      [60.16938210215323, 30.52343117861925],
      [60.169491691416795, 30.523710128356804],
      [60.16958791583364, 30.52421438365159],
      [60.169748289233354, 30.524777647544717],
      [60.17028820723881, 30.524997588683952],
      [60.1697536349998, 30.52602219252763],
      [60.169569205552506, 30.527449127723568],
      [60.16954514946108, 30.528275248100144],
      [60.169686812856284, 30.529031631042347],
      [60.16951627251812, 30.530202319504394],
      [60.16951359961564, 30.530754854561472],
      [60.16926769165248, 30.531688263298648],
      [60.16908593240584, 30.532289078117987],
      [60.16865024069221, 30.532471468330986],
      [60.16827602232275, 30.532728960396433],
      [60.168161082965064, 30.53280942666688],
      [60.16807554643709, 30.5329757236258],
      [60.16796862546289, 30.533962776543266],

      [60.16557611175042, 30.5227478858727],
      [60.1657324949815, 30.522592317749833],
      [60.16586882847117, 30.522270452668046],
      [60.16590358005424, 30.522039782692783],
      [60.16601585414752, 30.522002231766574],
      [60.16639811781691, 30.523300420929775],
      [60.16671354881347, 30.524732720543714],
      [60.16685255133907, 30.52556420533834],
      [60.16683651261623, 30.52656198709189],
      [60.16679641577474, 30.52707697122275],
    ],
    [],
  ...
  var startPoint = new ymaps.Placemark(
    ...
    {
      hintContent: "Токсовские высоты",
      balloonContent: `<figure class="popular-item swiper-slide">
      <img src="BALLON CONTENT/for-slider-2-СПБ-Токсовские-высоты.jpg" alt="Экотропа" class="trail-img">
      <figcaption class="trail-info">
          <a href="#" class="trail-title-link">
              <h2 title="Токсовские высоты" id="color-letters" class="bold-paragraph size-card-elem-h2">Токсовские высоты</h2>
          </a>
          <a href="#" id="trail-location" class="trail-location-black " title="Ленобласть, Всеволожский р-н, пос. Токсово">
              <p class="size-card-elem-p" id="color-letters">Ленобласть, Всеволожский р-н, пос. Токсово</p>
          </a>
          <div class="trail-spec">
              <a href="#" class="trail-distance">
                  <div class="img-card-color">
                  ...
                  <p id="color-letters" class="bold-paragraph">3,9 км</p>
              </a>
              <a href="#" class="trail-difficulty">
                  <div class="img-card-color">
                      <img src="BALLON CONTENT/difficulty-black.svg" alt="Сложность тропы">
              ...
              <a href="#" class="trail-duration">
                  ...
                  <p id="color-letters" class="bold-paragraph">~1,5 ч</p>
              </a>
          </div>
      </figcaption>
  </figure>
  ...
  var startPoint = new ymaps.Placemark(
    [44.43088285674113, 33.7059104185999],
    {
      hintContent: "Большая Севастопольская тропа",
      balloonContent: `<figure class="popular-item swiper-slide">
      <img src="BALLON CONTENT/for-slider-25-Крым-Большая-Севастопольская.jpg" alt="Экотропа" class="trail-img">
      <figcaption class="trail-info">
          <a href="#" class="trail-title-link">
              <h2 title="Большая Севастопольская тропа" id="color-letters" class="bold-paragraph size-card-elem-h2">Большая Севастопольская тропа</h2>
          </a>
          <a href="#" id="trail-location" class="trail-location-black " title="Крым, Севастополь, Балаклава">
              <p class="size-card-elem-p" id="color-letters">Крым, Севастополь, Балаклава</p>
          </a>
          <div class="trail-spec">
              <a href="#" class="trail-distance">
                  <div class="img-card-color">
                  ...
                  <p id="color-letters" class="bold-paragraph">117 км</p>
              </a>
              <a href="#" class="trail-difficulty">
                  <div class="img-card-color">
                      <img src="BALLON CONTENT/difficulty-black.svg" alt="Сложность тропы">
              ...
              <a href="#" class="trail-duration">
                  ...
                  <p id="color-letters" class="bold-paragraph">~40 ч</p>
              </a>
          </div>
      </figcaption>
  </figure>
  ...
  var startPoint = new ymaps.Placemark(
    [44.517312480501246, 33.98432226492472],
    {
      hintContent: "Большой каньон Крыма",
      balloonContent: `<figure class="popular-item swiper-slide">
      <img src="BALLON CONTENT/Большой каньон Крыма.jpg" alt="Экотропа" class="trail-img">
      <figcaption class="trail-info">
          <a href="#" class="trail-title-link">
              <h2 title="Большой каньон Крыма" id="color-letters" class="bold-paragraph size-card-elem-h2">Большой каньон Крыма</h2>
          </a>
          <a href="#" id="trail-location" class="trail-location-black " title="Крым, Бахчисарайский район">
              <p class="size-card-elem-p" id="color-letters">Крым, Бахчисарайский район</p>
          </a>
          <div class="trail-spec">
              <a href="#" class="trail-distance">
                  <div class="img-card-color">
              ...
              <a href="#" class="trail-difficulty">
                  ...
                  <p id="color-letters" class="bold-paragraph">Средняя</p>
              </a>
              <a href="#" class="trail-duration">
                  <div class="img-card-color">
                      <img src="BALLON CONTENT/duration-black.svg" alt="Длительность тропы">
  ...
  var startPoint = new ymaps.Placemark(
    [43.6586705395959, 40.250742455585296],
    {
      hintContent: "Реликтовый лес",
      balloonContent: `<figure class="popular-item swiper-slide">
      <img src="BALLON CONTENT/Реликтовый лес.jpg" alt="Экотропа" class="trail-img">
      <figcaption class="trail-info">
          <a href="#" class="trail-title-link">
              <h2 title="Реликтовый лес" id="color-letters" class="bold-paragraph size-card-elem-h2">Реликтовый лес</h2>
          </a>
          <a href="#" id="trail-location" class="trail-location-black " title="Краснодарский край, Сочи, с. Эсто-Садок">
              <p class="size-card-elem-p" id="color-letters">Краснодарский край, Сочи, с. Эсто-Садок</p>
          </a>
          <div class="trail-spec">
              <a href="#" class="trail-distance">
                  <div class="img-card-color">
                  ...
                  <p id="color-letters" class="bold-paragraph">1,5 км</p>
              </a>
              <a href="#" class="trail-difficulty">
                  <div class="img-card-color">
                      <img src="BALLON CONTENT/difficulty-black.svg" alt="Сложность тропы">
  ...
  var myPolyline = new ymaps.Polyline(
    [
      // Указываем координаты вершин.
      [60.735404925512206, 28.72070198149772],
      [60.73550736212986, 28.720559824419915],
      [60.73575031946325, 28.72002606482596],
      [60.73580679036305, 28.71973906846137],
      [60.73581467001555, 28.719352830363214],
      [60.7358575218952, 28.719025523496892],
      [60.73599410204761, 28.71829596264484],
      [60.73622392310388, 28.717418880296968],
      [60.73647869423162, 28.716345996691],
      [60.73656274199379, 28.716316492391854],
      [60.736608705520354, 28.71620115740421],
      [60.736686186744286, 28.715822965933096],
      [60.73674922217787, 28.715487689806242],
      [60.73679255896644, 28.715251655412928],
      [60.73684508832849, 28.715085358454008],
      [60.73689761760428, 28.714943201376233],
      [60.736973784901025, 28.71476081116321],
      [60.73704601234256, 28.71464279396655],
      [60.737090661952124, 28.714589149786264],
      [60.73729027120967, 28.71455159886005],
      [60.73737169041776, 28.714562327696104],
      [60.73749381884146, 28.714621336294446],
      [60.73762513920711, 28.714637429548524],
      [60.73788506747571, 28.714581231150238],
      [60.7381968091528, 28.71456977558561],
      [60.73843843290102, 28.714483944897136],
      [60.738517222859244, 28.713850943569614],
      [60.73853298082762, 28.713346688274825],
      [60.73859075997854, 28.712874619488197],
      [60.738632781113736, 28.712520567898228],
      [60.73874308633097, 28.71216651630828],
      [60.738774602037466, 28.711919753078888],
      [60.73860651791071, 28.711533514980758],
      [60.738580254686156, 28.71132966709563],
      [60.738580254686156, 28.711007802013842],
      [60.7386170231945, 28.71072885227629],
      [60.738716823218475, 28.710203139309375],
      [60.738837633357385, 28.70962378216214],
      [60.73888490676585, 28.70943066311309],
      [60.73897945337323, 28.709044425014934],
      [60.73905824199934, 28.70888349247404],
      [60.73942066718073, 28.708851305965855],
      [60.73977258335621, 28.708797661785567],
      [60.739930156508635, 28.708744017605277],
      [60.74014550522873, 28.70862600040862],
      [60.740402871310145, 28.708443610195594],
      [60.74058145063987, 28.708443610195594],
      [60.74070750603727, 28.708583085064383],
      [60.74088608366682, 28.708561627392253],
      [60.74102264235809, 28.708486525539833],
      [60.74113819156469, 28.70832559299894],
      [60.74134302776907, 28.708218304638358],
      [60.741474332338555, 28.708143202785937],
      [60.74162139281663, 28.70793935490081],
      [60.74178420898606, 28.707853524212336],
      [60.74197853687791, 28.70786425304839],
      [60.742130847103184, 28.707810608868073],
      [60.742398701257834, 28.707832066540202],
      [60.742614033364, 28.707885710720493],
      [60.742755836642445, 28.70789643955657],
      [60.74293440283979, 28.707520930294468],
      [60.743034189398365, 28.707327811245392],
      [60.743365058391966, 28.70675918293424],
      [60.74359316515344, 28.706517447369535],
      [60.743850503503545, 28.706442345517114],
      [60.74416035713754, 28.70656036271377],
      [60.74408683281801, 28.70689295663161],
      [60.74407107758467, 28.707257737057635],
      [60.74395553896993, 28.707633246319713],
      [60.74380323743115, 28.70790146722121],
      [60.7435721578498, 28.708341349499655],
      [60.74336733591645, 28.708684672253547],
      [60.74316251267181, 28.70927475823683],
      [60.74306797842432, 28.70961808099075],
      [60.743109993679916, 28.70975755585951],
      [60.743209779690794, 28.709789742367697],
      [60.74340409892413, 28.70954297913833],
      [60.74349863217845, 28.709500063794092],
      [60.74360366880008, 28.70954297913833],
      [60.74362467608302, 28.709660996334986],
      [60.74320604780555, 28.709797855761654],
      [60.7430484907856, 28.710029866841435],
      [60.74293557444403, 28.710200187113887],
      [60.7426650987959, 28.710744675543896],
      [60.74236310872004, 28.711157735732208],
      [60.74211888857403, 28.71135621919929],
      [60.74174073757326, 28.711613711264732],
      [60.74142298223503, 28.71173172846139],
      [60.7411761288025, 28.71180683031381],
      [60.7406088839114, 28.71183901682197],
      [60.74050383745761, 28.712053593543178],
      [60.74032525769467, 28.7124183739692],
      [60.740188696027005, 28.712632950690384],
      [60.74003637655624, 28.71309429064096],
      [60.7399733475976, 28.71337324037851],
      [60.73998134198451, 28.71360766431613],
      [60.740128409324775, 28.7138758852176],
      [60.740306990186355, 28.714283580987864],
      [60.74042779432163, 28.71460544606965],
      [60.74037527084057, 28.715206260888987],
      [60.74025446650698, 28.715388651102014],
      [60.74007063295028, 28.715495939462617],
      [60.739970837148626, 28.715528125970774],
      [60.73987104103575, 28.715678329675615],
      [60.73971346759217, 28.716643924920977],
      [60.739524378435625, 28.71695506116671],
      [60.73919872226885, 28.717234010904264],
      [60.738978114595426, 28.717394943445157],
      [60.738757505401054, 28.717834825723603],
      [60.73854214733949, 28.718253250329916],
      [60.73834779857634, 28.718500013559282],
      [60.7379380865059, 28.719014997690145],
      [60.73762291980514, 28.71984111806672],
      [60.73726047426193, 28.720559950082716],
      [60.73689802461357, 28.72083889982027],
      [60.7367404365295, 28.7208603574924],
      [60.73659335361757, 28.720892544000556],
      [60.73646202901779, 28.72087108632845],
      [60.736383233999256, 28.721042747705397],
      [60.73628867972093, 28.721074934213583],
      [60.73620463123898, 28.720806713312083],
      [60.7361310886362, 28.720881815164503],
      [60.73604178667706, 28.721074934213583],
      [60.73591045981388, 28.721107120721765],
      [60.735896013826014, 28.721072252004568],
      [60.735850049275825, 28.72105347654145],
      [60.73577913241176, 28.721120531766832],
      [60.735700335711826, 28.721195633619253],
      [60.740606373014565, 28.71183740636574],
      [60.740433702692016, 28.71180656096205],
      [60.740332595448756, 28.71178242108149],
      [60.740144823048496, 28.711731459110215],
      [60.739972806805625, 28.71163221737665],
      [60.739733820872296, 28.711508835761965],
      [60.73954341871379, 28.71144982716365],
      [60.73946069190564, 28.71142300507349],
      [60.739275540655285, 28.711428369491518],
      [60.73914947961648, 28.711460555999704],
      [60.739006347209944, 28.71155979773324],
      [60.738915740126245, 28.711675132720885],
      [60.738772606674154, 28.711943353622384],
      [60.739970544382615, 28.71337215392874],
      [60.73986549583314, 28.713495535543423],
      [60.739777517407596, 28.713747663190816],
      [60.739655397699586, 28.713892502477606],
      [60.73952802503442, 28.714085621526685],
      [60.73937438928943, 28.714383346727352],
      [60.739327116604095, 28.71442089765356],
      [60.73910388353541, 28.714453084161722],
      [60.738958124632504, 28.714404804399457],
      [60.73883468864596, 28.714404804399457],
      [60.73875458631485, 28.71444503753468],
      [60.73840922478794, 28.714506728342037],
    ],
    [],
  ...
  var startPoint = new ymaps.Placemark(
    [60.735404925512206, 28.72070198149772],
    {
      hintContent: "Монрепо",
      balloonContent: `<figure class="popular-item swiper-slide">
      <img src="BALLON CONTENT/Монрепо.jpg" alt="Экотропа" class="trail-img">
      <figcaption class="trail-info">
          <a href="#" class="trail-title-link">
              <h2 title="Монрепо" id="color-letters" class="bold-paragraph size-card-elem-h2">Монрепо</h2>
          </a>
          <a href="#" id="trail-location" class="trail-location-black " title="Выборг, парк Монрепо">
              <p class="size-card-elem-p" id="color-letters">Выборг, парк Монрепо</p>
          </a>
          <div class="trail-spec">
              <a href="#" class="trail-distance">
                  <div class="img-card-color">
                  ...
                  <p id="color-letters" class="bold-paragraph">5 км</p>
              </a>
              <a href="#" class="trail-difficulty">
                  <div class="img-card-color">
                      <img src="BALLON CONTENT/difficulty-black.svg" alt="Сложность тропы">
  ...
  var startPoint = new ymaps.Placemark(
    [60.23797777585307, 29.54010087421513],
    {
      hintContent: "Линдуловская роща",
      balloonContent: `<figure class="popular-item swiper-slide">
      <img src="BALLON CONTENT/for-slider-10-СПБ-Линдуловская-роща.jpg" alt="Экотропа" class="trail-img">
      <figcaption class="trail-info">
          <a href="#" class="trail-title-link">
              <h2 title="Линдуловская роща" id="color-letters" class="bold-paragraph size-card-elem-h2">Линдуловская роща</h2>
          </a>
          <a href="#" id="trail-location" class="trail-location-black " title="Ленобласть, Выборгский р-н, Рощинское">
              <p class="size-card-elem-p" id="color-letters">Ленобласть, Выборгский р-н, Рощинское</p>
          </a>
          <div class="trail-spec">
              <a href="#" class="trail-distance">
                  <div class="img-card-color">
                  ...
                  <p id="color-letters" class="bold-paragraph">5,5 км</p>
              </a>
              <a href="#" class="trail-difficulty">
                  <div class="img-card-color">
                      <img src="BALLON CONTENT/difficulty-black.svg" alt="Сложность тропы">
  ...
  var myPolyline = new ymaps.Polyline(
    [
      ...
      [60.60963293798124, 29.345521015756372],
      [60.609746324495696, 29.345263523690953],
      [60.60980960981835, 29.345140142076268],
      [60.61022359823281, 29.344829005830533],
      [60.611481352005214, 29.342924637429967],
      [60.61158154830391, 29.342672509782574],
      [60.612078303385104, 29.342686580356872],
      [60.612426345885446, 29.342783139881398],
      [60.61273483495319, 29.342756317791242],
      [60.61287985015927, 29.34285824173382],
      [60.613011681597406, 29.343072818455003],
      [60.6128244807941, 29.343330310520447],
      [60.61318954912298, 29.342880864996648],
      [60.61390933526513, 29.345053454298714],

      [60.61318691251409, 29.34285404290649],
      [60.61323700804596, 29.34263410176728],
      [60.61322118841275, 29.342398067373967],
      [60.613171092856234, 29.342140575308523],
      [60.61273341256985, 29.34274139012786],
      [60.613033988828846, 29.342274685759286],
      [60.61340838690706, 29.341931363005365],
      [60.61391197181482, 29.341512938399053],
      [60.61442345836151, 29.340997954268186],
      [60.61472240350601, 29.340678019823496],
      [60.61500186950241, 29.34028105288929],
      [60.6150994183822, 29.340071840586134],
      [60.615154783831, 29.33965878039782],

      [60.61515939198769, 29.339621229471636],
      [60.61518312000461, 29.339240355791507],
      [60.615172574221475, 29.33887557536548],
      [60.615151482644826, 29.33855907470172],
      [60.61603037110634, 29.33796228322454],
      [60.61627028041782, 29.33771551999515],
      [60.61642318871545, 29.33751167211002],
      [60.61684236463046, 29.33710397633976],
      [60.61726680763114, 29.336835755438287],
      [60.61825275919108, 29.338954700560034],
      [60.620095812628506, 29.340868909005433],
      [60.622209849299814, 29.345337469224244],

      [60.617268678853286, 29.336822464775715],
      [60.61760480207989, 29.336505964111954],
      [60.61799628235015, 29.335945382427838],
      [60.61900725480651, 29.334038331818256],
      [60.619352586224394, 29.33352871210542],
      [60.61968354823398, 29.333066974522737],
      [60.62045063731784, 29.33143082702364],
      [60.62087766867202, 29.33014873111452],
      [60.621323145953944, 29.327927862050192],
      [60.62158410315171, 29.32672086799349],
      [60.62191095564389, 29.325347576977865],
      [60.6222494319837, 29.324681653970558],
      [60.62297955858837, 29.3236409568728],
      [60.62324577391123, 29.322965040201044],
      [60.6234144636679, 29.322224750512916],
      [60.623498808214336, 29.321484460824816],
      [60.62350671550424, 29.320813908571083],
      [60.62361478160435, 29.31986977099785],
      [60.623767924738075, 29.319464398559226],
      [60.623920797384805, 29.31919081323973],
      [60.624139562149246, 29.318992329772623],
      [60.62475367696667, 29.31879384630552],
      [60.62495398655869, 29.318777753051414],
      [60.62518328679629, 29.318697286780967],
      [60.62537305127335, 29.318434430297522],
      [60.62556808581856, 29.31783897989621],
      [60.62564451795278, 29.317442012962],
      [60.625676144989626, 29.316841198142665],
      [60.62564978912774, 29.31640131586422],
      [60.62552328068989, 29.315720034774436],
      [60.62534405955074, 29.315001202758467],
      [60.62524654174645, 29.314470125373497],
      [60.62524390612601, 29.31411607378355],
      [60.625288711644046, 29.31381030195584],
      [60.62564451795278, 29.31208295935025],
      [60.62564451795278, 29.311787916358618],
      [60.62560761970378, 29.311567975219383],
      [60.62550219590187, 29.311278296645778],
      [60.62520437179354, 29.310859872039465],
      [60.624930265751104, 29.31044681185118],
      [60.624350418344626, 29.309701157745025],
      [60.62287703174891, 29.30788262003293],
      [60.622065190604005, 29.306863380607282],
    ],
    [],
  ...
  var startPoint = new ymaps.Placemark(
    [60.60963293798124, 29.345521015756372],
    {
      hintContent: "Раковые озера",
      balloonContent: `<figure class="popular-item swiper-slide">
      <img src="BALLON CONTENT/Раковые озера.jpg" alt="Экотропа" class="trail-img">
      <figcaption class="trail-info">
          <a href="#" class="trail-title-link">
              <h2 title="Раковые озера" id="color-letters" class="bold-paragraph size-card-elem-h2">Раковые озера</h2>
          </a>
          <a href="#" id="trail-location" class="trail-location-black " title="Ленобласть, Выборский р-н, Красносельское">
              <p class="size-card-elem-p" id="color-letters">Ленобласть, Выборский р-н, Красносельское</p>
          </a>
          <div class="trail-spec">
              <a href="#" class="trail-distance">
                  <div class="img-card-color">
                  ...
                  <p id="color-letters" class="bold-paragraph">8,3 км</p>
              </a>
              <a href="#" class="trail-difficulty">
                  <div class="img-card-color">
                      <img src="BALLON CONTENT/difficulty-black.svg" alt="Сложность тропы">
              ...
              <a href="#" class="trail-duration">
                  ...
                  <p id="color-letters" class="bold-paragraph">~2,5 ч</p>
              </a>
          </div>
      </figcaption>
  </figure>
  ...
  var startPoint = new ymaps.Placemark(
    [60.026807155822844, 29.675434768065582],
    {
      hintContent: "Западный Котлин",
      balloonContent: `<figure class="popular-item swiper-slide">
      <img src="BALLON CONTENT/Западный котлин.jpg" alt="Экотропа" class="trail-img">
      <figcaption class="trail-info">
          <a href="#" class="trail-title-link">
              <h2 title="Западный Котлин" id="color-letters" class="bold-paragraph size-card-elem-h2">Западный Котлин</h2>
          </a>
          <a href="#" id="trail-location" class="trail-location-black " title="СПб, Кронштадт">
              <p class="size-card-elem-p" id="color-letters">СПб, Кронштадт</p>
          </a>
          <div class="trail-spec">
              <a href="#" class="trail-distance">
                  <div class="img-card-color">
  ...
  var startPoint = new ymaps.Placemark(
    [60.004475450154104, 30.03664961944124],
    {
      hintContent: "Тропа Лукоморье",
      balloonContent: `<figure class="popular-item swiper-slide">
      <img src="BALLON CONTENT/Тропа лукоморье.jpg" alt="Экотропа" class="trail-img">
      <figcaption class="trail-info">
          <a href="#" class="trail-title-link">
              <h2 title="Тропа Лукоморье" id="color-letters" class="bold-paragraph size-card-elem-h2">Тропа Лукоморье</h2>
          </a>
          <a href="#" id="trail-location" class="trail-location-black " title="СПб, пос. Лисий нос">
              <p class="size-card-elem-p" id="color-letters">СПб, пос. Лисий нос</p>
          </a>
          <div class="trail-spec">
              <a href="#" class="trail-distance">
                  <div class="img-card-color">
                  ...
                  <p id="color-letters" class="bold-paragraph">4 км</p>
              </a>
              <a href="#" class="trail-difficulty">
                  <div class="img-card-color">
                      <img src="BALLON CONTENT/difficulty-black.svg" alt="Сложность тропы">
  ...
  var startPoint = new ymaps.Placemark(
    [59.70248632223368, 30.119334067809042],
    {
      hintContent: "Дудерговские высоты",
      balloonContent: `<figure class="popular-item swiper-slide">
      <img src="BALLON CONTENT/Дудерговские высоты.jpg" alt="Экотропа" class="trail-img">
      <figcaption class="trail-info">
          <a href="#" class="trail-title-link">
              <h2 title="Дудерговские высоты" id="color-letters" class="bold-paragraph size-card-elem-h2">Дудерговские высоты</h2>
          </a>
          <a href="#" id="trail-location" class="trail-location-black " title="СПб, Красное Село, проспект 25-го Октября">
              <p class="size-card-elem-p" id="color-letters">СПб, Красное Село, проспект 25-го Октября</p>
          </a>
          <div class="trail-spec">
              <a href="#" class="trail-distance">
                  <div class="img-card-color">
                  ...
                  <p id="color-letters" class="bold-paragraph">2,5 км</p>
              </a>
              <a href="#" class="trail-difficulty">
                  <div class="img-card-color">
                      <img src="BALLON CONTENT/difficulty-black.svg" alt="Сложность тропы">
  ...
  var startPoint = new ymaps.Placemark(
    [43.5455814134358, 39.78831236305254],
    {
      hintContent: "Тропа здоровья",
      balloonContent: `<figure class="popular-item swiper-slide">
      <img src="BALLON CONTENT/Тропа здоровья.jpg" alt="Экотропа" class="trail-img">
      <figcaption class="trail-info">
          <a href="#" class="trail-title-link">
              <h2 title="Тропа здоровья" id="color-letters" class="bold-paragraph size-card-elem-h2">Тропа здоровья</h2>
          </a>
          <a href="#" id="trail-location" class="trail-location-black " title="Краснодарский край, Сочи, с. Эсто-Садок">
              <p class="size-card-elem-p" id="color-letters">Краснодарский край, Сочи, с. Эсто-Садок</p>
          </a>
  ...
  var startPoint = new ymaps.Placemark(
    ...
    {
      hintContent: "Гряда Вярямянселькя",
      balloonContent: `<figure class="popular-item swiper-slide">
      <img src="BALLON CONTENT/Гряда Вярямянселькя.jpg" alt="Экотропа" class="trail-img">
      <figcaption class="trail-info">
          <a href="#" class="trail-title-link">
              <h2 title="Гряда Вярямянселькя" id="color-letters" class="bold-paragraph size-card-elem-h2">Гряда Вярямянселькя</h2>
          </a>
          <a href="#" id="trail-location" class="trail-location-black " title="Ленобласть, Приозерский р-н, Раздольевское">
              <p class="size-card-elem-p" id="color-letters">Ленобласть, Приозерский р-н, Раздольевское</p>
          </a>
          <div class="trail-spec">
              <a href="#" class="trail-distance">
                  <div class="img-card-color">
                  ...
                  <p id="color-letters" class="bold-paragraph">11 км</p>
              </a>
              <a href="#" class="trail-difficulty">
                  <div class="img-card-color">
                      <img src="BALLON CONTENT/difficulty-black.svg" alt="Сложность тропы">
  ...
  var startPoint = new ymaps.Placemark(
    [59.95596530417698, 30.69663745171536],
    {
      hintContent: "Колтушские высоты",
      balloonContent: `<figure class="popular-item swiper-slide">
      <img src="BALLON CONTENT/Колтушские высоты.jpg" alt="Экотропа" class="trail-img">
      <figcaption class="trail-info">
          <a href="#" class="trail-title-link">
              <h2 title="Колтушские высоты" id="color-letters" class="bold-paragraph size-card-elem-h2">Колтушские высоты</h2>
          </a>
          <a href="#" id="trail-location" class="trail-location-black " title="Ленобласть, Всеволожский р-н, пос. Воейково">
              <p class="size-card-elem-p" id="color-letters">Ленобласть, Всеволожский р-н, пос. Воейково</p>
          </a>
          <div class="trail-spec">
              <a href="#" class="trail-distance">
                  <div class="img-card-color">
  ...
  var myPolyline = new ymaps.Polyline(
    [
      // Указываем координаты вершин.
      [60.13136577725712, 29.99710671506734],
      [60.13124067327301, 29.997562690599864],
      [60.13120120186346, 29.997656567915403],
      [60.13109817457066, 29.99781213603824],
      [60.131017893338935, 29.998053534849586],
      [60.13095099216237, 29.998378082140384],
      [60.13091887954914, 29.998780413492618],
      [60.13085733028593, 29.999029858931024],
      [60.130755639945754, 29.99931953750463],
      [60.1305616246063, 29.999649449213454],
      [60.13050141271586, 29.999778195246165],
      [60.13043049634755, 29.999992771967374],
      [60.13031542417838, 30.000561400278528],
      [60.130178942710124, 30.000891311987356],
      [60.13007457414531, 30.000966413839777],
      [60.12981766549383, 30.000939591749617],
      [60.12973738112754, 30.001036151274143],
      [60.12962765884244, 30.001282914503538],
      [60.129504555353925, 30.001679881437717],
      [60.12935201343367, 30.00205539069982],
      [60.12913791831385, 30.002452357634027],
      [60.12900678436282, 30.002640112265055],
      [60.12886762122913, 30.002768858297763],
      [60.12861873184458, 30.002919062002604],
      [60.12848759581776, 30.002908333166552],
      [60.12842068947964, 30.002913697584578],
      [60.12821729337364, 30.003160460813945],
      [60.12795234129125, 30.00362180076452],
      [60.12752680771025, 30.004742964132724],
      [60.12744651773628, 30.005032642706354],
      [60.12722705747124, 30.005987509115638],
      [60.126515139675, 30.00818692050786],
      [60.12609761678685, 30.0090774139008],
      [60.125926323808145, 30.00937782131046],
      [60.12556767623697, 30.009774788244666],
      [60.12538567447715, 30.009914263113455],
      [60.12522508385045, 30.01003228031011],
      [60.12501631486041, 30.01028977237553],
      [60.12494137182194, 30.01043997608037],
      [60.12477542591321, 30.011030062063632],
      [60.12451312260341, 30.011620148046916],
      [60.12436858723029, 30.011813267095995],
      [60.12426152358039, 30.011866911276282],
      [60.12412234031312, 30.011813267095995],
      [60.12403668877824, 30.011695249899336],
      [60.12391891755258, 30.011609419210863],
      [60.12382791222503, 30.011545046194495],
      [60.12351742156035, 30.011405571325735],
      [60.12329793500724, 30.011266096456946],
      [60.123003499520024, 30.011266096456946],
      [60.122650173447184, 30.011319740637262],
      [60.12229149005674, 30.011512859686313],
      [60.12220583374164, 30.01156650386663],
      [60.122114823661825, 30.011609419210863],
      [60.1218953277247, 30.011791809423862],
      [60.121633001385774, 30.011748894079627],
      [60.121445624145224, 30.011663063391154],
      [60.121236831102244, 30.011673792227207],
      [60.12113208756198, 30.011685683771127],
      [60.120888493221464, 30.01158375982855],
      [60.12039862220389, 30.011540844484312],
      [60.12006936052457, 30.01145501379584],
      [60.11993551336884, 30.011374547525392],
      [60.11966514044879, 30.011304810091026],
      [60.11944295113387, 30.01137991194342],
      [60.11929571642161, 30.011449649377813],
      [60.11907620162379, 30.011460378213865],
      [60.118910226045614, 30.01141746286963],
      [60.1188406231339, 30.011358454271313],
      [60.11880849866333, 30.011133148714052],
      [60.11885668535741, 30.010698630853636],
      [60.11897982880965, 30.010205104394903],
      [60.11916186610988, 30.00965793375588],
      [60.11923682235171, 30.009480907960878],
      [60.11943759715592, 30.009341433092118],
      [60.119691910144205, 30.009432628198617],
      [60.11994889810899, 30.009529187723142],
      [60.12007739133653, 30.009507730051038],
      [60.12008332100403, 30.009226861268797],
      [60.12015559821033, 30.008915725023062],
      [60.12038581343584, 30.008357825547986],
      [60.120538397055654, 30.00801450279407],
      [60.12068027241637, 30.00775701072865],
      [60.12115140128846, 30.00706500080281],
      [60.12252994975237, 30.004361334115778],
      [60.12344499799793, 30.002472737148373],
      [60.12356544757745, 30.002102592304325],
      [60.1238143753071, 30.00171635420617],
      [60.12416768884152, 30.00130865843591],
      [60.124261369822285, 30.001163819149095],
      [60.12444605440073, 30.00050936014947],
      [60.12453438144026, 30.000160672977547],
      [60.12459326600114, 29.999978282764523],
      [60.12497333653319, 29.999447205379578],
      [60.125067015213205, 29.99938283236321],
      [60.125385520724286, 29.999232628658397],
      [60.125556816526995, 29.99905023844537],
      [60.12593955235407, 29.998363592937558],
      [60.12597434629871, 29.998224118068773],
      [60.12599575793864, 29.997902252986986],
      [60.12599308148442, 29.997617938831407],
      [60.126156344792435, 29.997263887241463],
      [60.12640525286217, 29.996824004963017],
      [60.126586158128696, 29.996738526273475],
      [60.126976911068795, 29.996422025609714],
      [60.127712905677754, 29.995134565282566],
      [60.12790268380067, 29.994765002412823],
      [60.12824792449296, 29.994303662462272],
      [60.12008091908905, 30.009500636275305],
      [60.12023818874395, 30.00933836262992],
      [60.12038274231501, 30.009173406775492],
      [60.12057112182926, 30.008919971679777],
      [60.120682212854895, 30.00871210048114],
      [60.1209800152547, 30.00792755434428],
      [60.12117676412136, 30.007484989856824],
      [60.12130993700438, 30.00721945116434],
      [60.1214357480757, 30.00700621554765],
      [60.12152264689233, 30.00686080924381],
      [60.12184520200611, 30.00639678708425],
      [60.12194424318891, 30.006205009139666],
      [60.12201450871164, 30.006013231195105],
      [60.122080566970595, 30.005742630107854],
      [60.12221708213822, 30.00497685943409],
    ],
    [],
  ...
  var startPoint = new ymaps.Placemark(
    [60.13136544275513, 29.99710336230608],
    {
      hintContent: "Сестрорецкое болото",
      balloonContent: `<figure class="popular-item swiper-slide">
      <img src="BALLON CONTENT/Сестрорецкое болото.jpg" alt="Экотропа" class="trail-img">
      <figcaption class="trail-info">
          <a href="#" class="trail-title-link">
              <h2 title="Сестрорецкое болото" id="color-letters" class="bold-paragraph size-card-elem-h2">Сестрорецкое болото</h2>
          </a>
          <a href="#" id="trail-location" class="trail-location-black " title="Ленобласть, пос. Белоостров">
              <p class="size-card-elem-p" id="color-letters">Ленобласть, пос. Белоостров</p>
          </a>
          <div class="trail-spec">
              <a href="#" class="trail-distance">
                  <div class="img-card-color">
                  ...
                  <p id="color-letters" class="bold-paragraph">3,5 км</p>
              </a>
              <a href="#" class="trail-difficulty">
                  <div class="img-card-color">
                      <img src="BALLON CONTENT/difficulty-black.svg" alt="Сложность тропы">
  ...
  var startPoint = new ymaps.Placemark(
    [43.247298523267474, 42.560450183484974],
    {
      hintContent: "Поляна нарзанов",
      balloonContent: `<figure class="popular-item swiper-slide">
      <img src="BALLON CONTENT/Поляна нарзанов.jpg" alt="Экотропа" class="trail-img">
      <figcaption class="trail-info">
          <a href="#" class="trail-title-link">
              <h2 title="Поляна нарзанов" id="color-letters" class="bold-paragraph size-card-elem-h2">Поляна нарзанов</h2>
          </a>
          <a href="#" id="trail-location" class="trail-location-black " title="Кабардино-Балкария, Эльбрусский р-н, с. Терскол">
              <p class="size-card-elem-p" id="color-letters">Кабардино-Балкария, Эльбрусский р-н, с. Терскол</p>
          </a>
          <div class="trail-spec">
              <a href="#" class="trail-distance">
                  <div class="img-card-color">
  ...
  var myPolyline = new ymaps.Polyline(
    [
      ...
      [60.1145760925161, 30.306064534325536],
      [60.114487738664785, 30.306032347817375],
      [60.11425212723169, 30.305485177178326],
      [60.1136523814054, 30.304825353760673],
      [60.11355867012998, 30.304669785637806],
      [60.113068689675636, 30.302518654007848],
      [60.112985686797586, 30.302202153344087],
      [60.11280897029352, 30.301665711541116],
      [60.1123511094703, 30.300625014443334],
      [60.112112805110925, 30.300083208222336],
      [60.11185040055635, 30.29956822409147],
      [60.11180720394407, 30.29948604043839],
      [60.11163851397199, 30.299309014643416],
      [60.11169206643801, 30.29912662443039],
      [60.11184201287802, 30.298767208422394],
      [60.11212048302061, 30.29810202058671],
      [60.11217938986339, 30.297908901537635],
      [60.112532828699855, 30.297806977595055],
      [60.11290768391271, 30.297565578783715],
      [60.11326111490629, 30.29709887441514],
      [60.11352350818212, 30.29678237375138],
      [60.11386354532684, 30.29670727189896],
      [60.11395725573171, 30.29680383142351],
      [60.11410451439874, 30.29702377256272],
      [60.11420893378043, 30.297173976267562],
      [60.114324062457186, 30.297372459734664],
      [60.11444186812696, 30.297705053652503],
      [60.114524867322174, 30.29810202058671],
      [60.114559673373854, 30.298418521250472],
      [60.1145114803694, 30.29956114229081],
      [60.114372255736846, 30.30004393991349],
      [60.114305320607116, 30.300279974306804],
      [60.11426783687482, 30.300623297060696],
      [60.11426783687482, 30.300816416109775],
      [60.114332094675376, 30.301138281191562],
      [60.11444990031633, 30.301599621142138],
      [60.114484706447485, 30.30177664693711],
      [60.11445257771232, 30.30203413900253],
      [60.11444722292008, 30.30209314760087],
      [60.11454628643526, 30.302302359904026],
      [60.11460518892415, 30.302243351305712],
      [60.114685510329515, 30.302286266649947],
      [60.11481402416923, 30.30244719919084],
      [60.115089791751615, 30.302946090067604],
      [60.115328074495395, 30.303428887690284],
      [60.115523518600405, 30.30387949880478],
      [60.115807312077884, 30.305070399607406],
      [60.1147042519625, 30.30518841680406],
      [60.11465070441134, 30.305360078181007],
      [60.11463196274779, 30.30599307950853],
      [60.114582431156876, 30.306054770315857],
      [60.11581035143282, 30.305071619606732],
      [60.11673801761909, 30.304975060082207],
      [60.11776176777444, 30.304860785844],
      [60.117863498401874, 30.304892972352185],
      [60.117981291365965, 30.305005625130814],
      [60.11808569841244, 30.305230930688076],
      [60.11812585488032, 30.30546160066334],
      [60.118182073852786, 30.306716874482305],
      [60.11826774067324, 30.307044103982143],
      [60.11859969748996, 30.30762346112935],
      [60.11929840207413, 30.308186725022477],
      [60.119488468563056, 30.308229640366715],
      [60.12150685320559, 30.307768300416164],
      [60.12162463309045, 30.307762935998113],
      [60.12173170534618, 30.30784340226856],
      [60.12353046699478, 30.30749471509664],
      [60.12371783232814, 30.307516172768747],
      [60.12392660958192, 30.307355240227853],
      [60.12575736858708, 30.306979730965775],
      [60.12583766269578, 30.307001188637905],
      [60.126153484283115, 30.30784876668661],
      [60.12613742563172, 30.30836375081745],
    ],
    [],
  ...
  var startPoint = new ymaps.Placemark(
    [60.1145760925161, 30.306064534325536],
    {
      hintContent: "Юкковские камы",
      balloonContent: `<figure class="popular-item swiper-slide">
      <img src="BALLON CONTENT/Юкковские камы.jpg" alt="Экотропа" class="trail-img">
      <figcaption class="trail-info">
          <a href="#" class="trail-title-link">
              <h2 title="Юкковские камы" id="color-letters" class="bold-paragraph size-card-elem-h2">Юкковские камы</h2>
          </a>
          <a href="#" id="trail-location" class="trail-location-black " title="Ленобласть, Всеволожский р-н, Юкковское">
              <p class="size-card-elem-p" id="color-letters">Ленобласть, Всеволожский р-н, Юкковское</p>
          </a>
          <div class="trail-spec">
              <a href="#" class="trail-distance">
                  <div class="img-card-color">
                  ...
                  <p id="color-letters" class="bold-paragraph">10 км</p>
              </a>
              <a href="#" class="trail-difficulty">
                  <div class="img-card-color">
                      <img src="BALLON CONTENT/difficulty-black.svg" alt="Сложность тропы">
              ...
              <a href="#" class="trail-duration">
                  ...
                  <p id="color-letters" class="bold-paragraph">~3,5 ч</p>
              </a>
          </div>
      </figcaption>
  </figure>
  ...
  var myPolyline = new ymaps.Polyline(
    [
      // Указываем координаты вершин.
      [43.624953633637595, 40.310001388885496],
      [43.62482114017896, 40.30990482936097],
      [43.624026173251565, 40.310527101852415],
      [43.62383132680105, 40.31065584788512],
      [43.62339486844407, 40.31096698413086],
      [43.62276355696035, 40.31122447619628],
      [43.622490765982, 40.311632171966565],
      [43.622334884863285, 40.31207205424498],
      [43.622186797423495, 40.31249047885132],
      [43.62184385667894, 40.312930361129766],
      [43.62147753143482, 40.313166395523076],
      [43.62112679239264, 40.31328441271974],
      [43.62066693141547, 40.31328441271974],
      [43.62034561792196, 40.313090722836],
      [43.61990133969743, 40.312758128918134],
      [43.61965191889432, 40.312768857754214],
      [43.619269991270215, 40.31314436701629],
      [43.61909851276671, 40.313734452999576],
      [43.618942622790726, 40.31485025194976],
      [43.618849088609736, 40.315322320736385],
      [43.61856848518767, 40.31595532206391],
      [43.61835803175568, 40.31616989878509],
  ...
  var startPoint = new ymaps.Placemark(
    [43.624953633637595, 40.310001388885496],
    {
      hintContent: "Каменный столб",
      balloonContent: `<figure class="popular-item swiper-slide">
      <img src="BALLON CONTENT/Каменный столб.jpg" alt="Экотропа" class="trail-img">
      <figcaption class="trail-info">
          <a href="#" class="trail-title-link">
              <h2 title="Каменный столб" id="color-letters" class="bold-paragraph size-card-elem-h2">Каменный столб</h2>
          </a>
          <a href="#" id="trail-location" class="trail-location-black " title="Краснодарский край, Сочи, Роза Хутор">
              <p class="size-card-elem-p" id="color-letters">Краснодарский край, Сочи, Роза Хутор</p>
          </a>
          <div class="trail-spec">
              <a href="#" class="trail-distance">
                  <div class="img-card-color">
                  ...
                  <p id="color-letters" class="bold-paragraph">4,4 км</p>
              </a>
              <a href="#" class="trail-difficulty">
                  <div class="img-card-color">
                      <img src="BALLON CONTENT/difficulty-black.svg" alt="Сложность тропы">
              ...
              <a href="#" class="trail-duration">
                  ...
                  <p id="color-letters" class="bold-paragraph">~5 ч</p>
              </a>
          </div>
      </figcaption>
  </figure>
  ...
  var startPoint = new ymaps.Placemark(
    [44.706555430968244, 37.5953947629349],
    {
      hintContent: "Путь к дому Виноградаря",
      balloonContent: "",
    },
    {
      iconLayout: "default#image",
  ...
  var startPoint = new ymaps.Placemark(
    [44.70654439987693, 37.59539666235058],
    {
      hintContent: "Путь к дому Виноградаря",
      balloonContent: `<figure class="popular-item swiper-slide">
      <img src="BALLON CONTENT/Путь к дому Виноградаря.jpg" alt="Экотропа" class="trail-img">
      <figcaption class="trail-info">
          <a href="#" class="trail-title-link">
              <h2 title="Путь к дому Виноградаря" id="color-letters" class="bold-paragraph size-card-elem-h2">Путь к дому Виноградаря</h2>
          </a>
          <a href="#" id="trail-location" class="trail-location-black " title="Краснодарский край, Сочи, Роза Хутор">
              <p class="size-card-elem-p" id="color-letters">Краснодарский край, Сочи, Роза Хутор</p>
          </a>
          <div class="trail-spec">
              <a href="#" class="trail-distance">
                  ...
                  <p id="color-letters" class="bold-paragraph">4,3 км</p>
              </a>
              <a href="#" class="trail-difficulty">
                  <div class="img-card-color">
                      <img src="BALLON CONTENT/difficulty-black.svg" alt="Сложность тропы">
  ...
  var startPoint = new ymaps.Placemark(
    [44.706007554037924, 37.58597882673448],
    {
      hintContent: "Ботаническая тропа",
      balloonContent: `<figure class="popular-item swiper-slide">
      <img src="BALLON CONTENT/Ботаническая тропа.jpg" alt="Экотропа" class="trail-img">
      <figcaption class="trail-info">
          <a href="#" class="trail-title-link">
              <h2 title="Ботаническая тропа" id="color-letters" class="bold-paragraph size-card-elem-h2">Ботаническая тропа</h2>
          </a>
          <a href="#" id="trail-location" class="trail-location-black " title="Краснодарский край, Сочи, Роза Хутор">
              <p class="size-card-elem-p" id="color-letters">Краснодарский край, Сочи, Роза Хутор</p>
          </a>
          <div class="trail-spec">
              <a href="#" class="trail-distance">
                  ...
                  <p id="color-letters" class="bold-paragraph">3,8 км</p>
              </a>
              <a href="#" class="trail-difficulty">
                  <div class="img-card-color">
                      <img src="BALLON CONTENT/difficulty-black.svg" alt="Сложность тропы">
